                          ...
                          <tr>
                            <td>
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tbody>
                                  <tr>
                                    <td role="modules-container" style="padding:10px; color:#000000; text-align:left;"
                                      ...
                                      <table class="wrapper" role="module" data-type="image" border="0" cellpadding="0"
                                        ...
                                        data-muid="b276c771-f9f7-49f0-b6c2-7fd72e92c358">
                                        <tbody>
                                          <tr>
                                            <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                              ...
                                              <img class="max-width" border="0"
                                                ...
                                                src="https://allocations-public.s3.us-east-2.amazonaws.com/logo-new.png">
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                      ...
                                      <table class="module" role="module" data-type="text" border="0" cellpadding="0"
                                        cellspacing="0" width="100%" style="table-layout: fixed;"
                                        data-muid="4d2d501d-dd9e-4e74-9bc4-6eebdaae4635"
                                        ...
                                        <tbody>
                                          ...
                                          <table>
                                            <tbody>
                                              <tr>
                                                <td class="paragraph bullet" height="100%" valign="top" bgcolor=""
                                                  role="module-content" style="padding-top: 10px" colspan="1">
                                                  <div style="font-family: inherit; text-align: start">
                                                    <span style="font-family: helvetica, sans-serif;">
                                                      Signing deadline:
                                                    </span>
                                                ...
                                                <td class="paragraph bullet value" height="100%" valign="top" bgcolor=""
                                                  role="module-content" style="padding-top: 10px" colspan="2">
                                                  <div style="font-family: inherit; text-align: start">
                                                    <span style="font-family: helvetica, sans-serif;">
                                                      ${signDate}, 5:00 pm EST
                                                    </span>
                                                  </div>
                                                </td>
                                              </tr>
                              ...
                              <table class="module" role="module" data-type="spacer" border="0" cellpadding="0"
                                cellspacing="0" width="100%" style="table-layout: fixed;"
                                data-muid="d13ed318-e363-46cd-bb41-10d12348955e">
                                <tbody>
                                  <tr>
                              ...
                              <table class="module" role="module" data-type="text" border="0" cellpadding="0"
                                cellspacing="0" width="100%" style="table-layout: fixed;"
                                data-muid="e458197e-0a71-4758-8251-344c387368fd" data-mc-module-version="2019-10-22">
                                <tbody>
                                  <tr>
                                    <td
                                      style="padding:18px 10px 18px 10px; line-height:12px; text-align:inherit; background-color:#ebebeb;"
                                      height="100%" valign="top" bgcolor="#ebebeb" role="module-content">
                                      <div>
                                        <div style="font-family: inherit; text-align: inherit">
                                          <span style="font-size: 9px">
                                            Disclaimer: This email and any files transmitted with it are
                                            confidential and intended solely for the use of the individual or
                                            entity to whom they are addressed. Please note this email and files
                                            are not legal, tax, accounting or investment advice. Allocations
                                            Crowdfunding is a funding portal, not a broker dealer or investment
                                            adviser, operated by Allocations Crowdfunding LLC.
                                          </span>
                                        </div>
                                        <div>
                                        </div>
