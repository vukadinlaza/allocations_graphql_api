...
module.exports = function template ({ data: { username, issuer, reason, refundAmount, refundDate} }) {
  return `
                                                              ...
                                                              <tr>
                                                                <td class="paragraph" height="100%" valign="top" bgcolor="" role="module-content" colspan="2">
                                                                  <div>
                                                                    <div style="font-family: inherit; text-align: start">
                                                                      <span style="font-family: helvetica, sans-serif;">
                                                                        Thank you for your commitment to invest in ${issuer} through Allocations Crowdfunding!
                                                                      </span>
                                                                    </div>
                                                                  </div>
                                                                </td>
                                                              ...
                                                              <tr>
                                                                <td class="paragraph" height="100%" valign="top" bgcolor="" role="module-content" colspan="2">
                                                                  <div>
                                                                    <div style="font-family: inherit; text-align: start">
                                                                      <span style="font-family: helvetica, sans-serif;">
                                                                        This is a notice to inform you that your commitment has been cancelled. In light of that, your commitment has been cancelled and you will soon receive a refund of your commitment.
                                                                      </span>
                                                                    </div>
                                                                  </div>
                                                                </td>
                                                              ...
                                                              <tr>
                                                                <td class="paragraph" height="100%" valign="top" bgcolor="" role="module-content" colspan="2">
                                                                  <div>
                                                                    <div style="font-family: inherit; text-align: start">
                                                                      <span style="font-family: helvetica, sans-serif;">
                                                                        Please find below the relevant details pertaining to the cancellation:
                                                                      </span>
                                                                    </div>
                                                                  </div>
                                                                </td>
                                                              ...
                                                              <tr>
                                                                <td class="paragraph" height="100%" valign="top" bgcolor="" role="module-content" colspan="2">
                                                                  <div>
                                                                    <div style="font-family: inherit; text-align: start">
                                                                      <span style="font-family: helvetica, sans-serif;">
                                                                        Please note that no further investment commitments may be made with respect to this offering on our platform.
                                                                      </span>
                                                                    </div>
                                                                    <div>
                                                                    </div>
